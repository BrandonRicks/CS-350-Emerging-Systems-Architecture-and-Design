...
%.obj: ../%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"E:/Coding/CCStudio IDE/ccs/tools/compiler/ti-cgt-arm_20.2.5.LTS/bin/armcl" -mv7M4 --code_state=16 --float_support=vfplib -me --include_path="E:/Coding/CCStudio IDE/workspace/SingleByteProject" --include_path="E:/Coding/CCStudio IDE/workspace/SingleByteProject/Debug" --include_path="E:/Coding/CCStudio IDE/simplelink_cc32xx_sdk_5_20_00_06/source" --include_path="E:/Coding/CCStudio IDE/simplelink_cc32xx_sdk_5_20_00_06/kernel/nortos" --include_path="E:/Coding/CCStudio IDE/simplelink_cc32xx_sdk_5_20_00_06/kernel/nortos/posix" --include_path="E:/Coding/CCStudio IDE/ccs/tools/compiler/ti-cgt-arm_20.2.5.LTS/include" --define=NORTOS_SUPPORT -g --diag_warning=225 --diag_warning=255 --diag_wrap=off --display_error_number --gen_func_subsections=on --preproc_with_compile --preproc_dependency="$(basename $(<F)).d_raw" --include_path="E:/Coding/CCStudio IDE/workspace/SingleByteProject/Debug/syscfg" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: "$<"'
	@echo ' '
...
syscfg/%.obj: ./syscfg/%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Building file: "$<"'
	@echo 'Invoking: Arm Compiler'
	"E:/Coding/CCStudio IDE/ccs/tools/compiler/ti-cgt-arm_20.2.5.LTS/bin/armcl" -mv7M4 --code_state=16 --float_support=vfplib -me --include_path="E:/Coding/CCStudio IDE/workspace/SingleByteProject" --include_path="E:/Coding/CCStudio IDE/workspace/SingleByteProject/Debug" --include_path="E:/Coding/CCStudio IDE/simplelink_cc32xx_sdk_5_20_00_06/source" --include_path="E:/Coding/CCStudio IDE/simplelink_cc32xx_sdk_5_20_00_06/kernel/nortos" --include_path="E:/Coding/CCStudio IDE/simplelink_cc32xx_sdk_5_20_00_06/kernel/nortos/posix" --include_path="E:/Coding/CCStudio IDE/ccs/tools/compiler/ti-cgt-arm_20.2.5.LTS/include" --define=NORTOS_SUPPORT -g --diag_warning=225 --diag_warning=255 --diag_wrap=off --display_error_number --gen_func_subsections=on --preproc_with_compile --preproc_dependency="syscfg/$(basename $(<F)).d_raw" --include_path="E:/Coding/CCStudio IDE/workspace/SingleByteProject/Debug/syscfg" --obj_directory="syscfg" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: "$<"'
	@echo ' '
